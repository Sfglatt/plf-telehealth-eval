...
# Include mixed-modal participants
```{r mlm sens}
src_model_2 <- lmer(srcs17 ~
  month:modality_type_new_f +
  month +
  modality_type_new_f +
  site_new_f +
  ssi +
  (1 | id), data = plf_data_treatment)

srce_model_2 <- lmer(srcse ~
  month:modality_type_new_f +
  month +
  modality_type_new_f +
  site_new_f +
...
# Results
summary(src_model_2)
summary(srce_model_2)
summary(srci_model_2)
